...
export const getWalletConnectRpcMap = (chainId: number) => ({
  chainId:
    `https://rpc.walletconnect.com?chainId=eip155:${chainId}&projectId=${process.env.REACT_APP_WALLET_CONNECT_PROJECT_ID}`
...
export const TESTNET_CHAINS: ChainConfig = {
  ...
  44787: {
    ...
    rpcMap: getWalletConnectRpcMap(44787)
  },
}
...
export const APP_CHAIN = TESTNET_CHAINS[APP_CHAIN_ID]
